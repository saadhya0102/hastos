...
export const LANGUAGES: Record<LanguageId, LanguageConfig> = {
  c: { id: "c", label: "C (GCC)", monaco: "c", judge0Id: 50, ext: "c", gated: false },
  cpp: { id: "cpp", label: "C++ (GCC)", monaco: "cpp", judge0Id: 54, ext: "cpp", gated: false },
  rust: { id: "rust", label: "Rust", monaco: "rust", judge0Id: 73, ext: "rs", gated: false },
  go: { id: "go", label: "Go", monaco: "go", judge0Id: 60, ext: "go", gated: true },
  asm: { id: "asm", label: "x86-64 Assembly (NASM)", monaco: "asm", judge0Id: 45, ext: "asm", gated: true },
  python: { id: "python", label: "Python 3", monaco: "python", judge0Id: 71, ext: "py", gated: false },
};
